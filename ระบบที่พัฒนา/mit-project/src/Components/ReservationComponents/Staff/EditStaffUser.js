// CSS
import './style/EditStaffUser.css';
// Utils
...
function EditStaffUser() {
    ...
    const submitEditStaffForm = (e) => {
        ...
        if(GetUserCheckEmail.IdUser == id.IdUser || GetUserCheckEmail == null) 
        {
            ...
            navigate('/Reservation/VaccinePlace', { state: { id: ObjectId } });
        }
    }
        ...
        <>
            <div className="editStaffContainer">
                <div className='editStaffForm'>
                    <h2 className="headTitle">แก้ไขข้อมูลบุคลากร</h2>
                    <form onSubmit={submitEditStaffForm}>
                        <div className='hrForm'>
                            <h3>ข้อมูลส่วนตัว</h3>
                            <hr />
                        </div>
                        <div className="editStaffRow1">
